public class TDMap
{
	...
	void BuildMap()
	{
		...
		_tiles[13] = new TDTile (TDTile.TYPE.MOUNTAIN, 13, new UnityEngine.Vector3 (2, 0, 13));
		_tiles[14] = new TDTile (TDTile.TYPE.GRASSLAND, 14, new UnityEngine.Vector3 (2, 0.5f, 14));
    }
}